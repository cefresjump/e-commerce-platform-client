...
export const goodsApi = {
  ...
  addInfo: (data: { merchantId: string | Blob; name: string | Blob; type: string | Blob; price: string | Blob; description: string | Blob; figure: string | Blob; }) => {
    const formData = new FormData();
  ...
  getGoodsCommentInfo: (data: any) => api.post('/goods/getGoodsCommentInfo', data),
};
...
export const orderApi = {
  ...
  getSellerInfo: (data: any) => api.post('/order/getSellerInfo', data),
